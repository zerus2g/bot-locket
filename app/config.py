...
ADMIN_IDS = [7193749511, 8394780963]
NUM_WORKERS = 2
...
TEXTS = {
    "VI": {
        ...
        "help_msg": (
            ...
            f"/redeem [key] - Kích hoạt VIP\n"
            f"/myref - Xem link mời & bonus\n"
    ...
    "EN": {
        ...
        "help_msg": (
            ...
            f"/redeem [key] - Activate VIP\n"
            f"/myref - View invite link & bonus\n"
